module.exports = {
  ...
  development: {
    ...
    // Current dist path is `/front/assets/vendor` which will be used by templates from `html\` directory. Set distPath: '/front/assets/vendor' to generate assets in dist folder.
    distPath: '/front/assets/vendor',
